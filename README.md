...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/typing_inspect-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6483&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/typing_inspect-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `typing_inspect` can be installed with:

```
conda install typing_inspect
```

It is possible to list all of the versions of `typing_inspect` available on your platform with:
